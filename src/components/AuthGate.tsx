...
ALLOWED_EMAIL=you@example.com
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-4 sm:p-6 pt-safe bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans overflow-x-hidden">
      <div aria-hidden="true" className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] rounded-full blur-[180px] bg-emerald-600/5 hidden dark:block" />
      </div>
